...
typedef void (VKAPI_PTR *PFN_vkUpdateDescriptorSetWithTemplate)(VkDevice device, VkDescriptorSet m_descriptorSetFactory, VkDescriptorUpdateTemplate descriptorUpdateTemplate, const void* pData);
...
typedef void (VKAPI_PTR *PFN_vkUpdateDescriptorSetWithTemplateKHR)(VkDevice device, VkDescriptorSet m_descriptorSetFactory, VkDescriptorUpdateTemplate descriptorUpdateTemplate, const void* pData);
